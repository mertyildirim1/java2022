...
public class Brand {
	...
	@Id // sen bir primaryKey'sin
	@GeneratedValue(strategy = GenerationType.AUTO) // benzersiz - tekrar edemez
...
//ctrl + shift + o kullanılmayan importları kaldırır. -----> strategy = GenerationType.IDENTITY
